...
pub extern "C" fn _start() -> ! {
    ...
    // 本 crate 的静态 Mutex/AtomicBool 全在 .bss，脏数据会直接破坏状态。
    unsafe {
        extern "C" {
...
fn main() {
    panic!("zero-blkdrv must be built for the bare-metal target");
}
